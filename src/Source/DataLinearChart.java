...
public class DataLinearChart extends JPanel {
    ...
    private DefaultCategoryDataset createDataset() {
        ...
        String title1 = Main.useLanguage.getActiveLanguage().getP();
        String title2 = Main.useLanguage.getActiveLanguage().getM();
        String title3 = Main.useLanguage.getActiveLanguage().getG();
